...
function toggleDark(){ document.documentElement.classList.toggle('dark'); store('dark', document.documentElement.classList.contains('dark')?1:0); }
function initDark(){ if(load('dark',1)===1) document.documentElement.classList.add('dark'); }
function baseInit(){ initDark(); initXL(); }
