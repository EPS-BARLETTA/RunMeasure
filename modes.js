...
(() => {
  ...
  function buildPayload(){
    ...
    if(state.mode==='tours'){ const dist=Math.round(state.cumDist + state.fractionAdded); return payload('Minuteur avec distance', { distance_totale:dist, vitesse_moyenne: kmh(dist,state.elapsed) }); }
